/**
 * AudioPlayer class for handling audio playback from AWS Nova Sonic
 */
export class AudioPlayer {
    ...
    private onAudioPlayedListeners: Array<(samples: Float32Array) => void> = [];
    ...
    async start(): Promise<void> {
        ...
        // Get the path to the audio worklet
        const workletUrl = '/AudioPlayerProcessor.js';
